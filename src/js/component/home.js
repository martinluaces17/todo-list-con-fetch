...
export function Home() {
	...
	const getData = () => {
		fetch("https://assets.breatheco.de/apis/fake/todos/user/martinluaces17")
			.then(resp => resp.json())
	...
	const updateData = updatedList => {
		...
		fetch(
			"https://assets.breatheco.de/apis/fake/todos/user/martinluaces17",
			options
		)
			.then(resp => resp.json())
	...
	return (
		<div className="container">
			<div className="row d-flex justify-content-center container">
				<div className="text-center mt-3">Agregar Tarea.</div>
				<div className="card col-12 mt-3 p-0 mb-3">
					...
					<ul className="list-group list-group-flush">
						{todoList.length === 0 ? (
							<li className="list-group-item p-1">Cargando...</li>
						) : (
